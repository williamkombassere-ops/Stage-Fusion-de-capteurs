...
def plot_data(timestamp, data):
    plt.plot(timestamp, data, '-', label='data')
...
if __name__ == "__main__":
    ...
    data = decode(args.log_name)
    plot_data(data['fixedFrequency']['timestamp'], data['fixedFrequency']['motor.m1'])
    plot_data(data['fixedFrequency']['timestamp'], data['fixedFrequency']['motor.m1req'])
